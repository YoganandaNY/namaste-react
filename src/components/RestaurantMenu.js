...
const RestaurantMenu = () => {
    ...
    const { lastMileTravelString, slaString } = resInfo?.cards[0]?.card?.card?.info?.sla;
            ...
            <div className="RestaurantHeader_container">
                <div className="RestaurantHeader_wrapper">
                    <div className="RestaurantNameAddress_wrapper">
                        ...
                        <div className="RestaurantNameAddress_areaWrapper">
                            ...
                            <p className="RestaurantNameAddress_lastMile">{","} {lastMileTravelString}</p>
                        </div>
                    </div>
                ...
                <ul>
                    <li className="RestaurantMessage_wrapper__2Mfts">
                        <img src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_18,h_18/SurgeAssets/distSurge" alt="DISTANCE_FEE_FOOD_LM" className="RestaurantMessage_icon__1qCvu"/>
                        <span className="RestaurantMessage_text__1k5GF" aria-hidden="true">Based on distance, an additional delivery fee will apply</span>
                        <span className="ScreenReaderOnly_screenReaderOnly___ww-V">Based on distance, an additional delivery fee will apply</span>
                    </li>
                </ul>
